...
describe('Logger', () => {
	...
	describe('#log', () => {
		it('should be able to log a message', () => {
			...
			console.log.should.always.have.been.calledWithExactly(
		...
		it('should convert Error message to meta', () => {
			...
			console.log.should.always.have.been.calledWithMatch(
		...
		it('should combine Error message meta', () => {
			...
			console.log.should.always.have.been.calledWithMatch(
				/^foo=bar error_message=whoops! error_name=Error error_stack="Error: whoops!/
			);
			console.log.should.always.have.been.calledWithMatch(/level=info$/);
		});
		...
		it('should handle message and Error meta', () => {
			...
			console.log.should.always.have.been.calledWithMatch(
				/^a message error_message=whoops! error_name=Error error_stack="Error: whoops!/
			);
			console.log.should.always.have.been.calledWithMatch(/level=info$/);
		});
		...
		it('should be able to send message, error and meta', () => {
			...
			console.log.should.always.have.been.calledWithMatch(
				/^a message extra=foo error_message=whoops! error_name=Error error_stack="Error: whoops!/
			);
			console.log.should.always.have.been.calledWithMatch(/level=info$/);
		});
		...
		it('should be able to send multiple metas, earlier arguments taking priority', () => {
			...
			console.log.should.always.have.been.calledWithExactly(
				'extra=foo anotherExtra=bar level=info'
			);
		});
	});
	...
	describe('#addContext', () => {
		it('should be able to add context to logs', () => {
			...
			logger.log('info', 'a message');
			console.log.should.always.have.been.calledWithExactly(
				'a message region=EU level=info'
			);
		});
		...
		it('should be able to add multiple context to logs', () => {
			...
			logger.log('info');
			console.log.should.always.have.been.calledWithExactly(
				'region=EU app=article level=info'
			);
		});
